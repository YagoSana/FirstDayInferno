...
export default class laboratorioFDI extends SalaBase {

    constructor(key) {
        super('laboratorioFDI');
    }

    create(data){
        super.create(data);

        const map = this.make.tilemap({ key: 'laboratorioFDI' }); // Cargamos el mapa
        ...
        const layer6 = map.createLayer('sin colision', [tileset1, tileset2],0,0);
