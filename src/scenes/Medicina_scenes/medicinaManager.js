...
export default class medicinaManager extends Phaser.Scene {
  ...
  init(data) {
    ...
    if (data && data.playerStats) {
      ...
      this.playerStats = { health: 3, coins: 0, equipedItem: null, itemSprite: null, speed: 100, shootCooldown: 500, pantallazo: false, doubleshoot: false  }; // Valores predeterminados
    }
