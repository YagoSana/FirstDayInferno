...
export default class informaticaManager extends Phaser.Scene {
  ...
  create() {
    ...
    this.mapStatus.set("FDI_3", false);
  // this.scene.start("FDI_1", {x: 358, y:170, playerStats: this.playerStats, managerKey: "informaticaManager", status: this.mapStatus.get("FDI_1")});
    this.scene.start("FDI_3", {x: 100, y:100, playerStats: this.playerStats, managerKey: "informaticaManager", status: this.mapStatus.get("FDI_4")});    
  } //358 170
