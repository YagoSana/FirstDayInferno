...
export default class FDI_Boss_1 extends SalaBase {
    ...
    create
        ...
        this.invisibleZoneBoss = this.add.zone(220, 150, 70, 100).setOrigin(0, 0).setName("empiezaBoss");
        this.invisibleZoneBoss.spawnRoom = "FDI_Boss_2";
        this.invisibleZoneBoss.spawnX = 300;
        this.invisibleZoneBoss.spawnY = 180;
        this.invisibleZoneBoss.prev = "FDI_Boss_1";
        this.invisibleZoneBoss.open = true;
        this.invisibleZoneBoss.setInteractive();
        this.physics.add.existing(this.invisibleZoneBoss);
        this.invisibleZoneBoss.body.setAllowGravity(false);
        this.invisibleZoneBoss.body.setImmovable(true);
        this.physics.add.overlap(this.player, this.invisibleZoneBoss, this.onOverlapBoss, null, this);
